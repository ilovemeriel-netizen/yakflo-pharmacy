...
export const FIELD_DEFS = [
  ...
  { key: 'category', col: 'category', label: '구분', required: true, type: 'vocab', vocab: 'category', input: 'select', section: 'basic', order: 3, aliases: ['구분', '분류', '제형', 'category'] },
  ...
  { key: 'specification', col: 'specification', label: '제형', type: 'string', input: 'text', section: 'detail', order: 23, aliases: ['제형', '규격', '포장규격', 'specification'] },
