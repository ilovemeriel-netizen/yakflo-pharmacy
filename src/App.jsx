...
function Report({drugs,onNav}){
  ...
  return<div style={{padding:'20px 24px'}}>
    ...
    {rtype==='annual'&&<div className="no-print" style={{marginBottom:14}}>
      ...
      <style>{'.cnc-print-month{display:none}.cnc-rpt-prn{display:none}.cnc-rvsep::before{content:" "}@media print{.cnc-rvsep::before{content:" — "}.cnc-rpt-hide{display:none!important}.cnc-print-month{display:flex!important;flex-direction:column;justify-content:space-between;page:summary;width:100%;max-width:186mm;min-height:265mm;margin:0 auto;padding:0;box-sizing:border-box;background:#fff}.cnc-print-month table{font-size:11.5pt!important}.cnc-print-month td,.cnc-print-month th{padding:7px 10px!important;font-size:11.5pt!important}.cnc-report-table{page:detail;page-break-before:always;overflow:visible!important}.cnc-report-table>div{overflow:visible!important}.cnc-report-table table{font-size:8px!important;table-layout:fixed;width:100%}.cnc-report-table thead{display:table-header-group!important}.cnc-report-table th,.cnc-report-table td{padding:2px 5px!important;font-size:8px!important;line-height:1.2}.cnc-report-table td:nth-child(2){word-break:break-all}.cnc-report-table th:nth-child(1),.cnc-report-table td:nth-child(1){width:11%}.cnc-report-table th:nth-child(2),.cnc-report-table td:nth-child(2){width:24%}.cnc-report-table th:nth-child(3),.cnc-report-table td:nth-child(3){width:7%}.cnc-rpt-scr{display:none!important}.cnc-rpt-prn{display:table-row-group!important}.cnc-report-table tfoot{display:table-row-group!important}}'}</style>
    ...
    <ThemeCtx.Provider value={themeVal}>
      <style>{`
        ...
        * { font-family: 'Roboto', 'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif; }
        ...
        @media print {
          @page { size: A4 portrait; margin: 12mm; } @page summary { size: A4 portrait; margin: 12mm; } @page detail { size: A4 landscape; margin: 10mm; }
