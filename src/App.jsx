...
function Ordering({ drugs, onAdjust }) {
  ...
  return <div style={{ padding: '20px 24px' }}>
    <div style={{ marginBottom: 14 }}><span style={{ fontSize: 18, fontWeight: 800, color: t.accent }}>발주 관리</span> <span style={{ fontSize: 12, fontWeight: 400, color: t.textM }}>현재고 ≤ 안전재고 후보 · 사용·휴면 기준 · 사용량 비의존(발주제안 = 안전 − 현재고)</span></div>
...
function DrugChangePlans({ drugs, onAdjust, onReload, navFilter }) {
  ...
  return <div style={{ padding: '20px 24px' }}>
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14, flexWrap: 'wrap', gap: 8 }}>
      <div style={{ fontSize: 18, fontWeight: 800, color: t.accent }}>약품변경 관리 <span style={{ fontSize: 12, fontWeight: 400, color: t.textM }}>· 예상일은 현재고·주간사용량으로 조회 시 재계산</span></div>
      <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
...
function AtcView({ drugs, onReload }) {
  ...
  return <div>
    ...
    <div className="no-print" style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center', marginBottom: 12 }}>
      <div style={{ fontSize: 18, fontWeight: 800, color: t.accent, marginRight: 8 }}>ATC 카세트 배치</div>
