...
function AtcView({ drugs, onReload }) {
  ...
  const assignable = propCand.filter(d => !isN(d) && !d.atc_excluded); /* 슬롯 배정 대상(향정·수기제외 건너뛰기) */
