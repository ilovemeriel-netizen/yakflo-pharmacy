    ...
    const reader=new FileReader();reader.onload=ev=>{
      try{
        ...
        rows.forEach((r,i)=>{
          ...
          updates.push({code,upd:{prev_year_usage:pv,recent_3m_usage:rv,monthly_avg:m,safety_stock:m!=null?Math.round(m*1.5):null,max_stock:m!=null?Math.round(m*3):null,usage_source:'manual'}})
        })
