...
function Dashboard({ drugs, inv, txns, onNav, onEdit }) {
  ...
  const [q, setQ] = useState(''); const [dq, setDq] = useState(''); const [catF, setCatF] = useState(null); const [cmpF, setCmpF] = useState(null); const [stoF, setStoF] = useState(null); const [locF, setLocF] = useState(null); const [insF2, setInsF2] = useState(null); const [locOpts, setLocOpts] = useState([])
  ...
  const luq = dq.trim().toLowerCase(); const luActive = !!(luq || catF || cmpF || stoF || locF || insF2)
