 ...
 */
export default function ColumnSelector({ t, groups, value, onChange, presets, limit = 12 }) {
  ...
  function place() {
    ...
    setPos({ top: r.bottom + 6, left: Math.max(8, Math.min(r.left, window.innerWidth - 372)) })
  }
      ...
      {open && createPortal(
        <>
          ...
          <div ref={menuRef} onClick={e => e.stopPropagation()}
            style={{ position: 'fixed', top: pos.top, left: pos.left, zIndex: 9999, width: 356, maxHeight: '70vh', overflowY: 'auto', background: t.cardSolid, border: '1px solid ' + t.borderH, borderRadius: 12, boxShadow: '0 12px 40px rgba(46,74,98,0.20)', padding: 12, textAlign: 'left' }}>
            {/* 프리셋 */}
