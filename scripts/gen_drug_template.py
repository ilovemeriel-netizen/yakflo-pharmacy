...
# 18컬럼 — (라벨, 필수여부, 너비, 숫자서식, 안내문)
#   필수(보라 #804A87): 약품코드·약품명·현재고·구입단가
#   권장(라벤더 #BFA6D9): 보험코드·품목기준코드·ATC번호·규격·제형·포장·안전재고·최대재고·보관위치
...
EX = [
    ['ABC01', '타이레놀정500mg', '645901230', '197000123', 'N02BE01', 100, '정제', '병',
     1200, 88, '경구제', '사용', 300, 2000, 'A-3-2', '2027-06-30', 'LOT2706', '예시 — 삭제하세요'],
    ['INJ07', '세프트리악손주1g', '642203450', '640012345', 'J01DD04', 1, '주사제', '바이알',
     48, 3910, '주사제', '사용', 20, 120, '냉장-B-1', '2026-11-30', 'CTX2611', '예시 — 삭제하세요'],
]
GUIDE = [
...
c = w2.cell(r + 1, 1,
            '성분명(한글·영문) · 약효분류 · 제조사 · 단위 · 보험약가 · 급여구분 · 전문/일반 · '
